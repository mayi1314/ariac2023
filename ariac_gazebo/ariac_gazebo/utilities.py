...
def euler_from_quaternion(quaternion):
    """
    Convert a quaternion to Euler angles (roll, pitch, yaw) following the convention used by tf2.

    :param quaternion: A list or tuple representing the quaternion in the form [w, x, y, z].
    ...
    # # Adjust the angles to match the tf2 convention
